...
final class MarketingContent
{
    ...
    public static function defaultHomepage(): array
    {
        return [
            ...
            'hero_title' => 'Artixcore builds secure SaaS platforms, AI systems, and scalable digital products.',
            'hero_title_prefix' => '',
            'hero_typed_phrases' => [],
            ...
            'intro_body' => 'We combine product thinking with senior engineering across Laravel, React, cloud, AI, and automation—so you can ship faster without sacrificing security or maintainability.',
            'stat_1_value' => '10+',
            ...
            'articles_subtitle' => 'Notes on SaaS engineering, AI, Laravel, React, cloud, and product craft.',
    ...
    public static function defaultAbout(): array
    {
        return [
            ...
            'meta_title' => 'About Artixcore | Software Engineering & Digital Product Company',
            'meta_description' => 'Learn about Artixcore, a software engineering company building secure SaaS platforms, AI systems, automation tools, and scalable digital products.',
            'og_title' => 'About Artixcore | Software Engineering & Digital Product Company',
            'og_description' => 'Learn about Artixcore, a software engineering company building secure SaaS platforms, AI systems, automation tools, and scalable digital products.',
            'lead' => 'We are a product-minded engineering studio partnering with ambitious teams worldwide.',
            'body_html' => '<p>Artixcore blends strategy, design, and implementation across modern stacks—from multi-tenant SaaS and AI-powered workflows to mobile apps and automation-heavy operations tools.</p><p>Our teams work as an extension of yours: transparent communication, pragmatic architecture, and outcomes you can measure.</p>',
    ...
    {
        return [
            'meta_title' => 'Services | SaaS, AI, Web App & Automation Development by Artixcore',
            'meta_description' => 'Explore Artixcore services including SaaS development, AI integration, web application engineering, API development, automation, cloud deployment, and product strategy.',
            'og_title' => 'Services | SaaS, AI, Web App & Automation Development by Artixcore',
            'og_description' => 'Explore Artixcore services including SaaS development, AI integration, web application engineering, API development, automation, cloud deployment, and product strategy.',
            'hero_badge' => 'What we build',
            'hero_title' => 'Services for teams shipping serious software',
            'hero_subtitle' => 'From discovery to production, we deliver SaaS platforms, web and mobile apps, AI-enabled systems, integrations, and automation—with clear milestones and senior engineers on the tools.',
    ...
    {
        return [
            'meta_title' => 'SaaS Platform Development | Artixcore',
            'meta_description' => 'Artixcore designs and builds scalable SaaS platforms with authentication, billing, dashboards, APIs, admin panels, analytics, and cloud-ready architecture.',
            'og_title' => 'SaaS Platform Development | Artixcore',
            'og_description' => 'Artixcore designs and builds scalable SaaS platforms with authentication, billing, dashboards, APIs, admin panels, analytics, and cloud-ready architecture.',
